...
function Column({ column }: ColumnProps) {
  return (
    <div className="flex flex-col flex-1 min-w-80 bg-zinc-50/50 dark:bg-zinc-900/50 backdrop-blur-xs rounded-lg border border-zinc-200 dark:border-zinc-800/50 h-full shadow-xs">

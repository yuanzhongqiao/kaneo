...
CREATE TABLE `__new_board` (
	...
	`name` text NOT NULL,
	`description` text,
	`created_at` integer DEFAULT '"2025-01-05T21:53:53.178Z"' NOT NULL,
...
CREATE TABLE `__new_user` (
	...
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2025-01-05T21:53:53.177Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_workspace_member` (
	...
	`role` text,
	`joined_at` integer DEFAULT '"2025-01-05T21:53:53.178Z"' NOT NULL,
	FOREIGN KEY (`workspace_id`) REFERENCES `workspace`(`id`) ON UPDATE no action ON DELETE cascade,

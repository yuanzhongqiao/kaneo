...
CREATE TABLE `__new_task` (
	...
	`due_date` integer,
	`created_at` integer DEFAULT '"2025-01-05T21:51:38.968Z"' NOT NULL,
...
CREATE TABLE `__new_workspace_member` (
	...
	`role` text,
	`joined_at` integer DEFAULT '"2025-01-05T21:51:38.967Z"' NOT NULL,
...
CREATE TABLE `__new_user` (
	...
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2025-01-05T21:51:38.967Z"' NOT NULL
);
--> statement-breakpoint
